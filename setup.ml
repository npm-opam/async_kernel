(* OASIS_START *)
(* DO NOT EDIT (digest: 971c3dd713b3f80300a948db4241d81e) *)
(*
...
let setup_t =
  {
     ...
     build =
       OCamlbuildPlugin.build
         [
            "-use-ocamlfind";
            "-plugin-tags";
            "'package(js-build-tools.ocamlbuild_goodies), package(ppx_driver.ocamlbuild)'"
         ];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_kernel";
          synopsis = "Monadic concurrency library";
          description =
            Some
              [
                 OASISText.Para
                   "Part of Jane Street\226\128\153s Core library The Core suite of libraries is an industrial strength alternative to OCaml's standard library that was developed by Jane Street, the largest industrial user of OCaml."
              ];
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("bin_prot", None);
                           FindlibPackage ("core_kernel", None);
                           FindlibPackage ("fieldslib", None);
                           FindlibPackage ("ppx_assert.runtime-lib", None);
                           FindlibPackage ("ppx_bench.runtime-lib", None);
                           FindlibPackage ("ppx_expect.collector", None);
                           FindlibPackage
                             ("ppx_inline_test.runtime-lib", None);
                           FindlibPackage ("sexplib", None);
                           FindlibPackage ("typerep", None);
                           FindlibPackage ("variantslib", None)
                        ];
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\203X\140E\028\005\148\198\136M?\233\199\242\191\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
